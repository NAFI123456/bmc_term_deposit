...
if page == "Home":
    ...
    st.title("st.markdown("<h1 style='text-align: center;'>Home Page</h1>", unsafe_allow_html=True)")
    ...
    st.title("st.markdown("<h1 style='text-align: center;'>Macro Economics Information</h1>", unsafe_allow_html=True)")
